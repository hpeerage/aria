          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-black text-foreground">{dict.common.story}</h2>
                </div>
              ...
              <div className="relative group bg-accent/[0.05] dark:bg-white/[0.05] p-10 rounded-[3rem] border border-accent/20 dark:border-white/10 overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <h3 className="text-2xl font-black text-foreground">{dict.common.wellnessTip}</h3>
            ...
            <section className="space-y-8">
              <div className="flex items-center justify-between px-6">
                <h3 className="text-2xl font-black text-foreground tracking-tight">{dict.common.nearbyTreasures}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {nearbyPlaces.map((np) => (
                  <Link key={np.id} href={`/places/${np.id}`} className="block group">
                    <motion.div 
                      whileHover={{ x: 10 }}
                      className="p-6 bg-white dark:bg-white/5 border border-foreground/5 dark:border-white/10 rounded-[2.5rem] flex items-center justify-between hover:border-accent/30 transition-all hover:shadow-xl shadow-black/5"
                    >
                      <div className="flex items-center gap-4">
                        <div className="p-4 bg-foreground/5 text-foreground group-hover:bg-accent group-hover:text-white rounded-2xl transition-all">
                      ...
                      <MoveRight className="w-5 h-5 text-foreground/10 group-hover:text-accent transition-all" />
                    </motion.div>
                  </Link>
                ))}
              </div>
